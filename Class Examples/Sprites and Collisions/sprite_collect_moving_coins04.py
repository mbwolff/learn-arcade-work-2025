...
class MyGame(arcade.Window):
    ...
    def __init__(self):
        ...
        self.rock_sound = arcade.load_sound(":resources:sounds/explosion2.wav")
    ...
    def on_update(self, delta_time):
        ...
        for coin in coins_hit_list:
            ...
            if not self.sound_player or not self.sound_player.playing:
                self.sound_player = arcade.play_sound(self.coin_sound)
        ...
        for rock in rocks_hit_list:
            if len(self.coin_list) > 0:
                ...
                self.score -= 1
                if not self.sound_player or not self.sound_player.playing:
                    self.sound_player = arcade.play_sound(self.rock_sound)
